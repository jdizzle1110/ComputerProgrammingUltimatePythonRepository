...
def equal_edge(num1, num2, num3, num4):
    ...
    if num1 == num4:
        ...
        return False
print(equal_edge(1,2,3,1))
print(equal_edge(4,2,3,1))
print(equal_edge(6,9,4,6))
print(equal_edge(8,2,3,1))
...
def common_edge(list1, list2):
     if list1[0] == list2[0] or list1[0] == list2[-1] == list1[-1] == list2[-1] or list1[-1] == list1[-1] == list2[-1] == list2[0]:
         return True 
     else: 
        return False 
...
def all_the_same(list1):
    if list1[0] == list1[1] and list[0] == list[2]:
        return True
    else:
        return False 
...
def mostly_true(list1):
    ...
    if first == "True" and middle == "True" or first == "True" and last == "True" and last == "Ture" or middle == "True" and first == "True" or middle == "True":
        return True
    else:
        return False
